...
class CategoryCRUD:
    ...
    def create(self, parent_category_id, en_category_name, mm_category_name, mon_category_name, description,):
        sql = '''INSERT INTO Category (parent_category_id, en_category_name, mm_category_name, mon_category_name, description, created_at)
